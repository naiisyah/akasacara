...
function article({ id, title, date, image }: ArticleProps) {
  return (
    <div className="flex flex-col pb-section items-start bg-akasacara">
      <div className="relative items-start self-stretch aspect-16/9">
        <Image
      ...
      <div className="flex flex-col pt-section px-container justify-center items-start gap-m self-stretch">
          <p className="headline-1 aka-text-title font-[700]">Menyakiti Laut dan Saatnya Penghakiman: Film Horor Darah Nyai Tayang Serempak 21 Agustus 2025</p>
      ...
      <div className="px-container w-full">
        <div className="flex flex-col items-start self-stretch aspect-16/9 relative">
          <Image
            src="/assets/DarahNyai.png"
            alt="gambar"
            fill
      ...
      <div className="py-section px-container flex flex-col items-start gap-xl self-stretch">
        ...
        <div className='grid grid-cols-2 gap-x-m gap-y-l'>
